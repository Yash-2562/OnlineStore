...
export default function PlaceOrder() {
  ...
  return !paymentCompleted ? (
    <form onSubmit={handleOrder} className="w-full mt-14 pb-5 gap-y-5 flex md:justify-evenly md:flex-row flex-col px-5">
      <div className="flex  w-full md:w-fit items-center md:items-start flex-col gap-2">
        ...
        <div>
          ...
          <input
            ...
            type="text"
            placeholder="Name"
            className="w-[300px] px-2 py-1.5 outline-none border bg-slate-600 border-black rounded-md text-white"
          />
        </div>
        <div>
        ...
        <div className="text-white mr-5">
          <h1 className="font-bold text-xl text-white">Payment method:</h1>
      ...
      <div className="border p-4 text-white flex items-center flex-col md:w-[300px] ">
