  ...
  return (
    <div className="w-full flex-wrap gap-x-3 overflow-hidden justify-center pb-5 gap-y-5 flex px-5">
      <div className="flex flex-row flex-wrap justify-center  w-fit items-center md:items-start md:flex-col gap-2">
        {cartItem.length === 0 ? (
          <div className="flex gap-2 w-full  flex-col justify-center items-center h-screen">
      ...
      {cartItem.length > 0 && (
        <div className="flex items-center text-white flex-col md:w-[300px] ">
          ...
          {totalAmount > 499 ? (
            ...
            <h1 className="flex items-center gap-1 text-xs font-bold text-white text-center">
              <span>Add </span>
      ...
      >
        <p className="text-center text-lg">Are you sure to Clear the Cart?
          <p className="text-sm">Mat kar bhai Dil se bura lagega 💔</p>
        </p>
